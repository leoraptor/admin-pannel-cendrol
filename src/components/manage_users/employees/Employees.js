...
import CustomPagination from "../../../re_use/CustomPagination";
...
const Employees = () => {
  ...
  const searchEmp = () => {
    // const searchId = designation.find((d) => search === d.designation)?._id;
    axiosInterceptor
    ...
    <div>
      <div className="tab_content">
        ...
        <div className="emp_input">
          <div className=" row ">
            <div className="col-lg-9 col-md-8 col-sm-7 input_row">
              <div className="d-flex align-items-center">
                <div className="input-group ">
                  ...
                  <input
                    className="emp_input_box form-control"
                  ...
                  <div className="input-group-append">
                    <button className="btn input_search " onClick={searchEmp}>
                      Search
                    </button>
                  </div>
                </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-5 mt-3 mt-md-0 text-center">
                  ...
                  empDetails.map((each_emp, index) => {
                    return (
                      ...
                      >
                        ...
                        <td>{each_emp.name || "-"}</td>
                        <td className="emp_id">{each_emp.emp_id || "-"}</td>
                        <td>{each_emp.department || "-"}</td>
                        <td style={{ width: "15%" }}>
      ...
      {/* pagination  */}
      <CustomPagination
        Page={trackPage.currentPage}
        TotalCount={10 * trackPage.numberOfPage}
